...
greeting.html("INDIA VS CORONA VIRUS")
greeting.position(displayWidth/2 - 200, displayHeight/2 - 250);

question1 = createElement('h3',"Do you think that our Corona Fighters our Doctors should be given some bravery award  ?")
...
question2 = createElement('h3',"Do you think that the reservation policies in the field of doctory should be abolished so as to get more and more doctors in our country?")
...
question3 = createElement('h3',"Do you think that strict actions should be taken against China for irresponsibility ?")
...
question4 = createElement('h3', "Do you think that the people who died due to this Corona Virus should be given a Compensation of Rs 5,00,000 ?");
